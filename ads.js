const gameInput = { gameName: 'TappyBird', publisherName: 'IndiaTodayGaming' };
...
window.enableSound = function(isenabled) {
    ...
    if (isenabled)
        gameInstance.SendMessage('Setting', 'AudioOn', 'on');
    else
        gameInstance.SendMessage('Setting', 'AudioOff', 'off');
}
